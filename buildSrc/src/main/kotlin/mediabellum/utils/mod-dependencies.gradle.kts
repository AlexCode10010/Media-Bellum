...
abstract class MediabellumModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<MediabellumModDependenciesExtension>("mediabellumModDependencies")
