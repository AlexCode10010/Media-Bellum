...
loom {
    forge {
        ...
        mixinConfig(
            "mediabellum-common.mixins.json",
            "mediabellum-forge.mixins.json",
        )
    }
    ...
    runs {
        register("commonDatagen") {
            ...
            property("mediabellum.apply-datagen-mixin", "true")
        }
    }
}

mediabellumModDependencies {
